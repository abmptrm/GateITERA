...
#define WIEGAND_D0_PIN 9  // PB0
#define WIEGAND_D1_PIN 10  // PB1
...
const unsigned long WIEGAND_TIMEOUT = 10; // Timeout untuk frame data Wiegand (100 ms)
...
// Fungsi Interrupt untuk Pin Change pada PB0 (D0) dan PB1 (D1)
ISR(PCINT1_vect) {
  // Jika PB1 (D1) adalah LOW, maka bit 1 diterima
  ...
  // Jika PB0 (D0) adalah LOW, maka bit 0 diterima
